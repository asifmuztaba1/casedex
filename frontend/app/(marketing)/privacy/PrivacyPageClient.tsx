    ...
    <section className="space-y-10">
      ...
      <div className="grid gap-6 md:grid-cols-2">
        {[
          ...
          {
            titleKey: "privacy.card5.title",
            descriptionKey: "privacy.card5.desc",
          },
          {
            titleKey: "privacy.card6.title",
            descriptionKey: "privacy.card6.desc",
          },
          {
            titleKey: "privacy.card7.title",
            descriptionKey: "privacy.card7.desc",
          },
          {
            titleKey: "privacy.card8.title",
            descriptionKey: "privacy.card8.desc",
          },
        ].map((item) => (
